...
const rows: { label: string; value: string }[] = [
  ...
  { label: "販売価格", value: "一口 10,000円(税込)" },
  ...
  {
    label: "商品の引渡時期",
    value: "決済完了後、直ちに支援チケットを発行いたします。チケットの発行をもって商品の引き渡しとします。",
  },
  {
    label: "返品・キャンセルについて",
    value:
      "本プロジェクトはクラウドファンディング型の支援であり、支援チケット発行という性質上、決済完了後のキャンセル・返金は原則お受けしておりません。",
  },
]
