...
export function VideoCard({ project, isHovered, onHoverChange, isMobile }: VideoCardProps) {
  ...
  return (
    <div
      className={cn(
        "group relative rounded-[1.5rem] sm:rounded-[2.5rem] overflow-hidden w-full",
      ...
      onClick={() => isMobile && onHoverChange(!isHovered)}
    >
      {/* Thumbnail Image */}
      ...
      >
        ...
        <div
          className={cn(
            ...
            isHovered || isMobile ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0",
          )}
        >
